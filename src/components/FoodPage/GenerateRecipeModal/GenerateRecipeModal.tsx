...
import { useGenerateRecipeByAIMutation } from "../../../redux/Features/Recipe/recipeApi";
import Textarea from "../../Reusable/TextArea/TextArea";
import { useForm } from "react-hook-form";
import { MarkdownRenderer } from "./MarkdownRenderer";

const GenerateRecipeModal = ({ setShowAIModal }: any) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const [generateRecipeByAI, { isLoading: isGenerating }] =
    useGenerateRecipeByAIMutation();
  ...
  const handleGenerateRecipe = async (data: any) => {
    try {
      ...
      const response = await generateRecipeByAI(payload).unwrap();
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Textarea
            label="Describe the recipe you want (e.g., ingredients, cuisine, type):"
